...
var ConditionCard_1 = require("./component/ConditionCard");
require("./App.css");
var data = [
    {
...
function App() {
    var conditions = data.map(function (condition, index) {
        return (<ConditionCard_1.ConditionCard label={condition.label} snippet={condition.snippet ? condition.snippet : undefined} image={condition.image ? condition.image : undefined}/>);
    });
